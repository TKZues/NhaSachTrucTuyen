...
<head>
    ...
    <title>Thêm flashsale main</title>
</head>
<body>
    <section>
        <div class="header">
    ...
    <?php
         ...
         if($_SERVER['REQUEST_METHOD']=== 'POST'){
            $flashsale = $connect-> insert_flashsalemain(); 
        }
    ?>
    <section>
        <div class="insert-flashsale_main l-12 c-12 m-12">
            <div class="insert-flashsale_main-content">
