...
<head>
    ...
    <link rel="stylesheet" href="./shopsystem.css">
                ...
                <div class="grid wide">
                    <div class="row list-shop-wrapper">
                        <div class="col l-8 m-12 c-12">
                            ...
                            <?php
                                $connect = new connect;
                                $show_shopsystem = $connect -> show_shopsystem();
                            ?>
                            <div class="row">

                            <?php
                                if($show_shopsystem){
                                    while($result = $show_shopsystem -> fetch_assoc()){
                                        $image_path = "/PS20232_Tranquocviet_ASMFINAL/assets/img/" . $result['hinhAnh'];
                                    
                            ?>
                                <div class="col l-6 m-6 c-12 list-shop__content">
                                    <img src="<?php echo $image_path ?>" alt="" class="list-shop__img">
                                    <div class="list-shop__dsc">
                                        <h5 class="list-shop__dsc-title">
                                            <?php echo $result['Ten']  ?>
                                        </h5>
                                        <div class="list-shop__dsc-text">
                                            <p><i class="fas fa-map-marker-alt"></i> <?php echo $result['diaChi']  ?></p>
                                            <p><i class="fa fa-phone"></i> <?php echo $result['dienThoai']  ?> 024 3637 4372</p>
                                            <p><i class="fas fa-map-marker-alt"></i> <?php echo $result['thoiGian']  ?> 10:00 - 22:00</p>
                                        </div>
                                    </div>
                                </div>
                            <?php
