...
<body>
    <div class="wrapper grid">
        ...
        <?php
            $connect = new connect;
            $show_cart = $connect->show_cart();

        ?>
        <div class="main">
             <div class="grid wide">
                <div class="main-content col c-12 m-12 l-12 ">
                    <div class="main-content-heading">
                        <label for="">TÍNH TIỀN</label>
                    </div>
                    <table class="main-content-class ">
                        <tr>
                            <th>Họ tên</th>
                            <th>Ngày đặt bàn</th>
                            <th>Số điện thoại</th>
                        ...
                        <?php
                            ...
                            // Check if there's data in the result
                            if ($show_cart) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['ngayDatBan'] ?></td>
                            <td><?php echo $result['soDienThoai'] ?></td>
                            <td><?php echo $result['nguoiLon'] ?></td>
                            
                            <td><?php echo $result['email'] ?></td>
                            <td><?php echo $result['treEm'] ?></td>
                            <td><?php echo $result['nhaHang'] ?></td>
                            <td><?php echo $result['chonGio'] ?></td>
                            <td><?php echo $result['chonPhut'] ?></td>
