               ...
               <div class="row blog__list">
                ...
                ?>
                   <div class="col l-4 m-6 c-12 blog__item">
                        <img src="<?php echo $image_path ?>" alt="" class="blog__item-img">
                        <div class="blog__item-dsc">
                            <div class="blog__item-name"><?php  echo $result['Ten'] ?></div>
                            <div class="blog__item-sub-dsc"><?php echo $result['moTa']  ?></div>
